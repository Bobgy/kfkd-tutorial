...
def fit_net2(fname='net.pickle', sfname='net2.pickle'):
	...
	net2 = NeuralNet(
		...
		hidden2_num_units=1000,
		hidden2_num_hidden=50,
		hidden2_W=l1[4].W.get_value(),
		hidden2_b=l1[4].b.get_value(),
		dropout2_p=0.3,

		hidden3_num_units=1000,
		hidden3_num_hidden=50,
		hidden3_W=l1[6].W.get_value(),
		hidden3_b=l1[6].b.get_value(),
		dropout3_p=0.4,

		hidden4_num_units=1000,
		hidden4_num_hidden=50,
		hidden4_W=l1[8].W.get_value(),
		hidden4_b=l1[8].b.get_value(),
